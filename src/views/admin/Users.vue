<template>
  <div class="bg-white p-6">
    ...
    <div v-if="showBulkActions && selectedUsers.length > 0" class="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
      <div class="flex gap-4">
        <button
          @click="sendMessageToSelected"
          class="px-4 py-2 bg-gradient-to-r from-purple-800 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-500 transition-all duration-300"
        >
          Message Selected
        </button>
        <button
          @click="updateSelectedStatus('active')"
          class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-500 transition-all duration-300"
        >
          Activate Selected
        </button>
        <button
          @click="updateSelectedStatus('inactive')"
    ...
    <UserMetricsSummary :metrics="userMetrics" class="mb-8" />
    ...
    <div class="mt-4 flex items-center justify-between">
      <div class="flex items-center gap-4">
        ...
        <select
          ...
          class="px-2 py-1 border border-gray-300 rounded-md text-sm text-gray-700 focus:ring-2 focus:ring-purple-500"
      ...
      <div class="flex items-center space-x-2">
        <button
          ...
          class="px-3 py-1 border border-gray-300 rounded-md disabled:opacity-50 text-gray-700 hover:bg-gray-50"
        >
          Previous
        </button>
